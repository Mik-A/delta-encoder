...
export async function handler(event, context, callback) {
  ...
  const NODE_ENV_GOOGLE_SERVICE_ACCOUNT_EMAIL =
    'sheets@colab-268805.iam.gserviceaccount.com'
  const NODE_ENV_GOOGLE_PRIVATE_KEY =
  ...
  await doc.useServiceAccountAuth({
    client_email: NODE_ENV_GOOGLE_SERVICE_ACCOUNT_EMAIL,
    private_key: NODE_ENV_GOOGLE_PRIVATE_KEY
  })
